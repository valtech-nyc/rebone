...
var uuid = require('uuid/v4'); // Disable console logging unless "Debug" is passed as a URL Param
...
var Loader = function Loader() {
  ...
  var init = function init() {
    ...
    (0, _backboneRedux.syncCollections)(collectionMap, _AppStore.store, _combinedReducers.reducers); // Register collections as data listeners (models TBD)
